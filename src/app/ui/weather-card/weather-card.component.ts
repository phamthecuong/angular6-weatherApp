...
export class WeatherCardComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
//    console.log('testtttt', this.weather.getGeneric<string>("this is getGeneric type"));
    ...
    this.weather.getWeatherState('Paris')
      .subscribe((data: string) => {
        this.condition = data;
        //console.log("this.condition", this.condition['weather'][0]['main']);
      });
  ...
  parentCall() {
    console.log("parent call from home compoment");
  }
